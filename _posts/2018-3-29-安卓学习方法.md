...
- 基础内容，包含了安卓的四大组件的介绍，组件调用，创建自定义组件，资源文件，动态权限等。
 
 ![pdb设置](/static/img/blog/android/安卓学习方法/安卓学习1.png)
- 主要概念里面，详细介绍了各个组件的详细用法，用户的导航、布局、ui组件等。
可以加入组https://groups.diigo.com/group/dhcjrbfeat，里面有一些阅读笔记。

![pdb设置](/static/img/blog/android/安卓学习方法/安卓学习2.png)
